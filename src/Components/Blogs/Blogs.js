        ...
        <div>
            <div className="mockup-window border border-base-300">
                <div className="md:flex-wrap lg:flex justify-center m-4 lg:px-4 lg:my-16 lg:py-24 border-t border-base-300">
                    <div className="card min-w-sm max-w-lg p-6 my-2 mx-4 bg-teal-700 text-primary-content" data-aos="zoom-in-right"
                    ...
                    <div className="card min-w-sm max-w-lg p-6 my-2 mx-4 bg-teal-700 text-primary-content" data-aos="zoom-in"
                        data-aos-easing="ease-out-cubic"
                    ...
                    <div className="card min-w-sm max-w-lg p-6 my-2 mx-4 bg-teal-700 text-primary-content" data-aos="zoom-in-left"
                        data-aos-easing="ease-out-cubic"
                        data-aos-duration="2000">
                        <div className="card-body">
