...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-24 bg-teal-800 text-base-content">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-teal-800 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Multistep Industries Ltd. Providing reliable tech since 1992</p>
                </div>
